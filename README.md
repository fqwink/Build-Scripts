...
機能仕様・運用仕様・API 仕様・CI 仕様の正本は `build_spec_v3_spec.md` です。

## 主要ファイル

- `build_spec_v3_spec.md`: Adlaire CI のマスター仕様書。
...
仕様や挙動を変更する場合は、先に `build_spec_v3_spec.md` を改訂し、その内容に基づいて実装ファイルと関連文書を整合させます。
