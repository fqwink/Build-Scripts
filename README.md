...
4. [`docs/ROADMAP.md`](docs/ROADMAP.md) 状態・計画責務: 状態分類、実装可否、Phase、将来計画を確認する。
5. [`docs/DETAIL_INDEX.md`](docs/DETAIL_INDEX.md) 詳細仕様入口責務: owner component 別の詳細仕様参照先を確認する。
