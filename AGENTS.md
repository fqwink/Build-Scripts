...
実装済みコンポーネントである `admin/adlaire-ci-sdk.js` と `admin/index.html` は、`docs/ADLAIRE_CI_SPEC.md`、`docs/ADLAIRE_CI_DETAIL_SPEC.md`、該当する owner component 別の `docs/ADLAIRE_CI_DETAIL_*_SPEC.md` に基づいて更新する。
