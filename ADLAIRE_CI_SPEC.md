...
| 仕様化済み・未実装 | 実装可 | 正本仕様と詳細仕様があり、実装対象として扱える項目。 | `ADLAIRE_CI_DETAIL_SPEC.md` §0h・§0i と該当 owner component の詳細仕様本文を確認して実装する。 |
...
3. `ADLAIRE_CI_DETAIL_SPEC.md` §0i の詳細節対応表に、対象機能、対象コンポーネント、詳細仕様節、受け入れ条件を追加する。
