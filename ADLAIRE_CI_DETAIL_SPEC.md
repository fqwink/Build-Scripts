...
| `admin` | 管理 UI 静的ファイルの配布物構成、配置、検証、HTTP 静的配信境界を固定する。 | `ADLAIRE_CI_DETAIL_ADMIN_SPEC.md` A0〜A5 | `api`、`ui`、`sdk`、`setup` | UI DOM 実装、SDK method 実装、API endpoint 実装、状態ファイル直接操作。 |
