...
上位判断、実装状態、実装可否、読取順は `docs/DETAIL_INDEX.md` §0b.1 を正とする。本ファイルは `api` owner component の主本文であり、collaborator component の仕様は呼び出し境界、schema、security、表示、fixture、検証観点として参照する。
...
backup / restore fixture は `docs/details/fixture.md` §22-F の API 機能別 fixture 固定契約を正とする。
...
api / sdk / ui / statefile にまたがる横断 fixture の fixture 名、入力、必須確認は `docs/details/fixture.md` §22-F の cross fixture 固定契約を正とする。
...
メンテナンス fixture は `docs/details/fixture.md` §22-F の API 機能別 fixture 固定契約を正とする。
...
アクセス制御 fixture は `docs/details/fixture.md` §22-F の API 機能別 fixture 固定契約を正とする。
...
hooks fixture は `docs/details/fixture.md` §22-F の API 機能別 fixture 固定契約を正とする。
...
SMTP fixture は `docs/details/fixture.md` §22-F の API 機能別 fixture 固定契約を正とする。
...
queue fixture は `docs/details/fixture.md` §22-F の API 機能別 fixture 固定契約を正とする。
...
認証 fixture は `docs/details/fixture.md` §22-F の API 機能別 fixture 固定契約を正とする。
...
approval fixture は `docs/details/fixture.md` §22-F の API 機能別 fixture 固定契約を正とする。
