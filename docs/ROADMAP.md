...
各 Phase の `対象` は、その Phase の owner component を示す。状態ファイル、security、archive、commitstatus、admin、setup が関わる場合も、それらは collaborator component として該当 Phase の判定条件に含める。fixture / expected / fake / 実装検証証跡は collaborator component ではなく [`docs/details/fixture.md`](details/fixture.md) fixture 証跡責務として判定条件に含める。collaborator component の詳細本文責務に未充足がある場合の扱いは [`docs/SPEC.md`](SPEC.md) 方針責務 §4.7 と [`docs/SPEC.md`](SPEC.md) ポリシー責務 §0d を参照する。

| Phase | 対象 | 実装範囲 | 依存条件 | 判定条件 |
|-------|------|----------|----------|----------|
| Phase 1 | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §2〜§9 の CLI、Markdown 変換、静的 Web サイト出力、テーマコンポーネント、生成物確認。 | なし。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0e の `builder` 必須検証と [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0f の `builder` 判定入口を満たす。 |
| Phase 2 | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §10〜§20 の CI ランナー、GitHub API 連携、SHA キャッシュ、pipeline 起動、SSH 転送、snapshot、通知、ログ、systemd / setup 参照境界。systemd unit 本文と配置手順は [`docs/details/setup.md`](details/setup.md) 詳細本文責務 §26 を参照する。 | Phase 1 が完了し、`adlaire-ci-build` の CLI 契約が固定されている。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0e の `runner` 必須検証と [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0f の `runner` 判定入口を満たす。 |
| Phase 3 | `api` | [`docs/details/api.md`](details/api.md) 詳細本文責務 §21〜§22、[`docs/details/api.md`](details/api.md) 詳細本文責務 §21a、[`docs/details/api.md`](details/api.md) 詳細本文責務 §25 と [`docs/details/setup.md`](details/setup.md) 詳細本文責務 §26 のうち、認証、セッション、共通エラー、状態ファイル読み書き、ビルド操作、status、logs、history、queue、circuit breaker。 | Phase 2 が完了し、runner が書き込む状態ファイル schema が固定されている。 | API 基盤・認証・状態 read/write・運用基本操作の必須検証、[`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0e の `api` API 共通・状態ファイル検証、[`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0f の `api` 判定入口の該当範囲を満たす。 |
| Phase 4 | `api` | [`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0f のうち、config、repo、branch、schedule、notify、snapshot、rollback、maintenance、access control、hooks、tokens 等の拡張運用操作。 | Phase 3 が完了し、API 共通処理と認証が固定されている。 | API 拡張運用操作の必須検証と [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0e の `api` endpoint 契約を満たす。 |
...
| 確認 | 参照先 |
|------|--------|
| API 共通処理、API server 制限、認証、運用基本 endpoint、状態 read/write | [`docs/details/api.md`](details/api.md) 詳細本文責務 §21〜§22、[`docs/details/api.md`](details/api.md) 詳細本文責務 §21a、[`docs/details/api.md`](details/api.md) 詳細本文責務 §25、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0f |
...
[`docs/ROADMAP.md`](ROADMAP.md) 状態・計画責務 §5.2.2 の統合ロードマップ表の `概要` は、状態・計画責務としての状態要約である。関数、処理順序、endpoint、状態 schema、UI DOM、SDK method の本文は owner component 別の [`docs/details/*.md`](details/) 詳細本文責務、fixture、expected、fake、実装検証証跡の本文は [`docs/details/fixture.md`](details/fixture.md) fixture 証跡責務を参照する。実装済み行は、実装済み状態と検証済み証跡の要約だけを示す。

[`docs/ROADMAP.md`](ROADMAP.md) 状態・計画責務 §5.2.2 の統合ロードマップ表の `確認先 / 次アクション` は、状態に応じた確認先または次作業だけを示す。実装済み行では検証済み証跡の要約を示し、fixture の入力、expected、fake、assertion 本文は [`docs/details/fixture.md`](details/fixture.md) fixture 証跡責務を参照する。未実装行では実装前に読む責務文書だけを示す。
...
| 仕様化済み・未実装 | 実装可 | CI ランナー | ポーリング間隔の動的変更 | [`docs/details/api.md`](details/api.md) 詳細本文責務と [`docs/details/setup.md`](details/setup.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.3、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/setup.md`](details/setup.md) 詳細本文責務 §26、[`docs/details/api.md`](details/api.md) 詳細本文責務 §27.11 に従って実装する。 |
...
| 仕様化済み・未実装 | 実装可 | CI ランナー | GitHub Webhook 受信 | [`docs/details/api.md`](details/api.md) 詳細本文責務と [`docs/details/runner.md`](details/runner.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.3、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22-W、[`docs/details/api.md`](details/api.md) 詳細本文責務 §27.12 に従って実装する。 |
...
| 仕様化済み・未実装 | 実装可 | CI ランナー | Webhook イベントログ | [`docs/details/api.md`](details/api.md) 詳細本文責務と [`docs/details/runner.md`](details/runner.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.3、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §11、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22-W、[`docs/details/api.md`](details/api.md) 詳細本文責務 §27.13 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ビルド所要時間の記録と統計 API | [`docs/details/runner.md`](details/runner.md) 詳細本文責務と [`docs/details/api.md`](details/api.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.4、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.14 に従って実装する。 |
...
| 仕様化済み・未実装 | 実装可 | 管理ツール・API | ビルドアーティファクト管理 | [`docs/details/archive.md`](details/archive.md) 詳細本文責務、[`docs/details/api.md`](details/api.md) 詳細本文責務、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務、[`docs/details/ui.md`](details/ui.md) 詳細本文責務の詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.4、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §14b、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務 §23、[`docs/details/ui.md`](details/ui.md) 詳細本文責務 §24、[`docs/details/archive.md`](details/archive.md) 詳細本文責務 §27.15 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | 管理ツール・API | ヘルスチェックエンドポイント | [`docs/details/api.md`](details/api.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.3、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/api.md`](details/api.md) 詳細本文責務 §27.16 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | 管理ツール・API | Webhook イベント一覧取得 API | [`docs/details/api.md`](details/api.md) 詳細本文責務、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務、[`docs/details/ui.md`](details/ui.md) 詳細本文責務の詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.3、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務 §23、[`docs/details/ui.md`](details/ui.md) 詳細本文責務 §24、[`docs/details/api.md`](details/api.md) 詳細本文責務 §27.13 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | 管理ツール・API | ビルドログ重大度フィルター | [`docs/details/api.md`](details/api.md) 詳細本文責務、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務、[`docs/details/ui.md`](details/ui.md) 詳細本文責務の詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.3、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務 §23、[`docs/details/ui.md`](details/ui.md) 詳細本文責務 §24、[`docs/details/api.md`](details/api.md) 詳細本文責務 §27.17 に従って実装する。 |
...
| 仕様化済み・未実装 | 実装可 | CI ランナー | ブランチ設定の動的変更 API | [`docs/details/api.md`](details/api.md) 詳細本文責務と [`docs/details/runner.md`](details/runner.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.3、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §11、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §12、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/api.md`](details/api.md) 詳細本文責務 §27.18 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | 週次ビルドサマリー Webhook | [`docs/details/runner.md`](details/runner.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.3、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §12、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §16、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.19 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | 管理ツール・API | 設定変更の詳細 diff 記録 | [`docs/details/api.md`](details/api.md) 詳細本文責務と [`docs/details/statefile.md`](details/statefile.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.3、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0a、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/api.md`](details/api.md) 詳細本文責務 §27.20 に従って実装する。 |
...
| 仕様化済み・未実装 | 実装可 | CI ランナー | 複数ファイル監視 | [`docs/details/runner.md`](details/runner.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §11、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §12、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.21 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | GitHub Commit Status API | [`docs/details/commitstatus.md`](details/commitstatus.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §12、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0c、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/commitstatus.md`](details/commitstatus.md) 詳細本文責務 §27.1 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ビルドパイプライン YAML 定義 | [`docs/details/runner.md`](details/runner.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §12、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.22 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ドライラン実行モード | [`docs/details/runner.md`](details/runner.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §11、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §12、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.2 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ビルドログのアーカイブ圧縮 | [`docs/details/archive.md`](details/archive.md) 詳細本文責務と [`docs/details/runner.md`](details/runner.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.4、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §12、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0c、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/archive.md`](details/archive.md) 詳細本文責務 §27.7 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ローカルファイル監視モード | [`docs/details/runner.md`](details/runner.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §11、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §12、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.23 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | タグ付きコミットのみビルド | [`docs/details/runner.md`](details/runner.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §12、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.24 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ビルドキャッシュ | [`docs/details/builder.md`](details/builder.md) 詳細本文責務と [`docs/details/runner.md`](details/runner.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.1、[`docs/details/builder.md`](details/builder.md) 詳細本文責務 §5、[`docs/details/builder.md`](details/builder.md) 詳細本文責務 §8、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §11、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/builder.md`](details/builder.md) 詳細本文責務 §27.25 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ビルド通知連携 | [`docs/details/runner.md`](details/runner.md) 詳細本文責務と [`docs/details/api.md`](details/api.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §16、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.32 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ビルド時間トレンド記録 | [`docs/details/runner.md`](details/runner.md) 詳細本文責務と [`docs/details/api.md`](details/api.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.33 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ビルド失敗時の自動リトライ | [`docs/details/runner.md`](details/runner.md) 詳細本文責務と [`docs/details/statefile.md`](details/statefile.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §12、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0c、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.3 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | 並列マルチターゲットビルド | [`docs/details/runner.md`](details/runner.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §12、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §14a、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.26 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ビルド前後フック | [`docs/details/runner.md`](details/runner.md) 詳細本文責務と [`docs/details/api.md`](details/api.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.27 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | 依存ファイルトラッキング | [`docs/details/builder.md`](details/builder.md) 詳細本文責務と [`docs/details/runner.md`](details/runner.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.1、[`docs/details/builder.md`](details/builder.md) 詳細本文責務 §4.3、[`docs/details/builder.md`](details/builder.md) 詳細本文責務 §5、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §11、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/builder.md`](details/builder.md) 詳細本文責務 §27.28 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | リモートビルド対応 | [`docs/details/runner.md`](details/runner.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §12、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §14a、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.29 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ビルドステータスファイル出力 | [`docs/details/runner.md`](details/runner.md) 詳細本文責務と [`docs/details/statefile.md`](details/statefile.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §11、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0a、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0c、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.8 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ビルド承認フロー | [`docs/details/runner.md`](details/runner.md) 詳細本文責務と [`docs/details/api.md`](details/api.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.3、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §11、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §16、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.30 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ブランチ別環境変数 | [`docs/details/runner.md`](details/runner.md) 詳細本文責務と [`docs/details/api.md`](details/api.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §12、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.31 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ビルド依存チェーン | [`docs/details/runner.md`](details/runner.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §11、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.34 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ビルド優先度キュー | [`docs/details/runner.md`](details/runner.md) 詳細本文責務と [`docs/details/api.md`](details/api.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §11、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.35 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | 失敗原因の自動分類 | [`docs/details/runner.md`](details/runner.md) 詳細本文責務と [`docs/details/api.md`](details/api.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.36 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ビルド実行環境の記録 | [`docs/details/runner.md`](details/runner.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.37 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ビルドトリガー種別の記録 | [`docs/details/runner.md`](details/runner.md) 詳細本文責務、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務、[`docs/details/api.md`](details/api.md) 詳細本文責務、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務、[`docs/details/ui.md`](details/ui.md) 詳細本文責務の詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0c、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務 §23、[`docs/details/ui.md`](details/ui.md) 詳細本文責務 §24、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.9、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.23、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.30 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | ビルド所要時間の異常検知 | [`docs/details/runner.md`](details/runner.md) 詳細本文責務と [`docs/details/api.md`](details/api.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §15、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §16、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.38 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | CI ランナー | 設定ファイル起動時整合性チェック | [`docs/details/runner.md`](details/runner.md) 詳細本文責務と [`docs/details/statefile.md`](details/statefile.md) 詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.2、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §11、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §12、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §13、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0a、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0c、[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.10 に従って実装する。 |
...
| 仕様化済み・未実装 | 実装可 | 管理ツール・API | TOTP 二要素認証 | [`docs/details/security.md`](details/security.md) 詳細本文責務、[`docs/details/api.md`](details/api.md) 詳細本文責務、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務、[`docs/details/ui.md`](details/ui.md) 詳細本文責務の詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.4、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0a、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務 §23、[`docs/details/ui.md`](details/ui.md) 詳細本文責務 §24、[`docs/details/security.md`](details/security.md) 詳細本文責務 §27.46 に従って実装する。 |
...
| 仕様化済み・未実装 | 実装可 | 管理ツール・API | 設定バリデーション API | [`docs/details/api.md`](details/api.md) 詳細本文責務、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務、[`docs/details/ui.md`](details/ui.md) 詳細本文責務の詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.3、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0c、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務 §23、[`docs/details/ui.md`](details/ui.md) 詳細本文責務 §24、[`docs/details/api.md`](details/api.md) 詳細本文責務 §27.5 に従って実装する。 |
...
| 仕様化済み・未実装 | 実装可 | 管理ツール・API | セッションタイムアウト変更設定 | [`docs/details/security.md`](details/security.md) 詳細本文責務、[`docs/details/api.md`](details/api.md) 詳細本文責務、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務、[`docs/details/ui.md`](details/ui.md) 詳細本文責務の詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.4、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0c、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務 §23、[`docs/details/ui.md`](details/ui.md) 詳細本文責務 §24、[`docs/details/security.md`](details/security.md) 詳細本文責務 §27.45 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | 管理ツール・API | ビルドトリガー専用 API スコープ | [`docs/details/security.md`](details/security.md) 詳細本文責務、[`docs/details/api.md`](details/api.md) 詳細本文責務、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務、[`docs/details/ui.md`](details/ui.md) 詳細本文責務の詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.4、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0a、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務 §23、[`docs/details/ui.md`](details/ui.md) 詳細本文責務 §24、[`docs/details/security.md`](details/security.md) 詳細本文責務 §27.42 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | 管理ツール・API | 監査ログ | [`docs/details/security.md`](details/security.md) 詳細本文責務、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務、[`docs/details/api.md`](details/api.md) 詳細本文責務、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務、[`docs/details/ui.md`](details/ui.md) 詳細本文責務の詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.4、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0a、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務 §23、[`docs/details/ui.md`](details/ui.md) 詳細本文責務 §24、[`docs/details/security.md`](details/security.md) 詳細本文責務 §27.44 に従って実装する。 |
| 仕様化済み・未実装 | 実装可 | 管理ツール・API | API レート制限 | [`docs/details/security.md`](details/security.md) 詳細本文責務、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務、[`docs/details/api.md`](details/api.md) 詳細本文責務、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務、[`docs/details/ui.md`](details/ui.md) 詳細本文責務の詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.4、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0a、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務 §23、[`docs/details/ui.md`](details/ui.md) 詳細本文責務 §24、[`docs/details/security.md`](details/security.md) 詳細本文責務 §27.47 に従って実装する。 |
...
| 将来計画 | 実装不可 | 管理ツール・API | API バージョニング | 将来計画候補。詳細本文、version path、互換境界、routing 境界は未定義。 | [`docs/ROADMAP.md`](ROADMAP.md) 状態・計画責務 §5.2.3 の手順で `改訂予定` へ昇格し、詳細仕様を追加する。 |
...
| 仕様化済み・未実装 | 実装可 | 管理ツール・API | API アクセスログ | [`docs/details/api.md`](details/api.md) 詳細本文責務、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務、[`docs/details/ui.md`](details/ui.md) 詳細本文責務の詳細本文責務に実装契約が定義済み。 | [`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務 §0i.3、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0a、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0c、[`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0e、[`docs/details/sdk.md`](details/sdk.md) 詳細本文責務 §23、[`docs/details/ui.md`](details/ui.md) 詳細本文責務 §24、[`docs/details/api.md`](details/api.md) 詳細本文責務 §27.6 に従って実装する。 |
...
[`docs/ROADMAP.md`](ROADMAP.md) 状態・計画責務 §5.2.3 の昇格手順を完了していない項目の実装着手可否は、[`docs/SPEC.md`](SPEC.md) ポリシー責務 §0a と [`docs/SPEC.md`](SPEC.md) ポリシー責務 §0d を参照する。
...
| 状態更新 | 状態ファイル更新は [`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0a、[`docs/details/statefile.md`](details/statefile.md) 詳細本文責務 §22.0c を基準とする。lock、atomic write、JSON Lines、破損時処理は [`docs/details/statefile.md`](details/statefile.md) 詳細本文責務を正本とする。 |
...
| fixture / 実装検証証跡 | 追加仕様化機能の fixture manifest、expected/effects、assertion、実装検証証跡、受け入れゲートは [`docs/details/fixture.md`](details/fixture.md) fixture 証跡責務 §27-F、builder 拡張 fixture は [`docs/details/fixture.md`](details/fixture.md) fixture 証跡責務 §28-F を参照する。 |
...
[`docs/ROADMAP.md`](ROADMAP.md) 状態・計画責務 §6.2 の追加仕様化機能を実装した変更は、対象節、owner component 別の [`docs/details/*.md`](details/) 詳細本文責務、collaborator component 別の [`docs/details/*.md`](details/) 詳細本文責務、fixture、secret mask、失敗時副作用、実装対象外を [`docs/details/fixture.md`](details/fixture.md) fixture 証跡責務の実装検証証跡に記録する。記録が不足する場合は、実装済みとして扱わない。

追加仕様化機能の責務分離、dry-run 固定契約、fixture 判定条件の詳細は、owner component 別の [`docs/details/*.md`](details/) 詳細本文責務と [`docs/details/fixture.md`](details/fixture.md) fixture 証跡責務 §27-F を参照する。builder 拡張 fixture 判定条件は、[`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28 と [`docs/details/fixture.md`](details/fixture.md) fixture 証跡責務 §28-F を参照する。[`docs/DETAIL_INDEX.md`](DETAIL_INDEX.md) 詳細仕様入口責務は同じ fixture schema、expected/effects、個別機能本文を持たない。
...
|----|------|-------|--------|--------------|
| [`docs/details/commitstatus.md`](details/commitstatus.md) 詳細本文責務 §27.1 | GitHub Commit Status API | `commitstatus` | [`docs/details/commitstatus.md`](details/commitstatus.md) 詳細本文責務 §27.1 | `runner`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.2 | ドライラン実行モード | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.2 | `statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.3 | ビルド失敗時の自動リトライ | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.3 | `statefile` |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §27.4 | 出力サイトへのビルドメタ埋め込み | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §27.4 | `runner`、`api`、`statefile` |
| [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.5 | 設定バリデーション API | `api` | [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.5 | `sdk`、`ui`、`statefile` |
| [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.6 | API アクセスログ | `api` | [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.6 | `sdk`、`ui`、`statefile` |
| [`docs/details/archive.md`](details/archive.md) 詳細本文責務 §27.7 | ビルドログのアーカイブ圧縮 | `archive` | [`docs/details/archive.md`](details/archive.md) 詳細本文責務 §27.7 | `runner`、`api`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.8 | ビルドステータスファイル出力 | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.8 | `api`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.9 | ビルドトリガー種別の記録 | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.9 | `api`、`sdk`、`ui`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.10 | 設定ファイル起動時整合性チェック | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.10 | `statefile` |
| [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.11 | ポーリング間隔の動的変更 | `api` | [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.11 | `runner`、`statefile` |
| [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.12 | GitHub Webhook 受信 | `api` | [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.12 | `runner`、`statefile` |
| [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.13 | Webhook イベントログ / 一覧取得 API | `api` | [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.13 | `sdk`、`ui`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.14 | ビルド所要時間の記録と統計 API | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.14 | `api`、`statefile`、`archive` |
| [`docs/details/archive.md`](details/archive.md) 詳細本文責務 §27.15 | ビルドアーティファクト管理 | `archive` | [`docs/details/archive.md`](details/archive.md) 詳細本文責務 §27.15 | `api`、`sdk`、`ui`、`runner`、`statefile` |
| [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.16 | ヘルスチェックエンドポイント | `api` | [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.16 | `statefile` |
| [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.17 | ビルドログ重大度フィルター | `api` | [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.17 | `sdk`、`ui`、`archive`、`statefile` |
| [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.18 | ブランチ設定の動的変更 API | `api` | [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.18 | `runner`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.19 | 週次ビルドサマリー Webhook | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.19 | `api`、`statefile` |
| [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.20 | 設定変更の詳細 diff 記録 | `api` | [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.20 | `statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.21 | 複数ファイル監視 | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.21 | `builder`、`api`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.22 | ビルドパイプライン YAML 定義 | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.22 | `api`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.23 | ローカルファイル監視モード | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.23 | `statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.24 | タグ付きコミットのみビルド | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.24 | `api`、`statefile` |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §27.25 | ビルドキャッシュ | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §27.25 | `runner`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.26 | 並列マルチターゲットビルド | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.26 | `statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.27 | ビルド前後フック | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.27 | `api`、`statefile` |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §27.28 | 依存ファイルトラッキング | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §27.28 | `runner`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.29 | リモートビルド対応 | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.29 | `api`、`archive`、`statefile` |
| [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.30 | ビルド承認フロー | `api` | [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.30 | `runner`、`sdk`、`ui`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.31 | ブランチ別環境変数 | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.31 | `api`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.32 | ビルド通知連携 | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.32 | `api`、`sdk`、`ui`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.33 | ビルド時間トレンド記録 | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.33 | `api`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.34 | ビルド依存チェーン | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.34 | `api`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.35 | ビルド優先度キュー | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.35 | `api`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.36 | 失敗原因の自動分類 | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.36 | `api`、`statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.37 | ビルド実行環境の記録 | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.37 | `statefile` |
| [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.38 | ビルド所要時間の異常検知 | `runner` | [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.38 | `api`、`statefile` |
| [`docs/details/security.md`](details/security.md) 詳細本文責務 §27.42 | ビルドトリガー専用 API スコープ | `security` | [`docs/details/security.md`](details/security.md) 詳細本文責務 §27.42 | `api`、`sdk`、`ui`、`statefile` |
| [`docs/details/security.md`](details/security.md) 詳細本文責務 §27.43 | API キー管理 | `security` | [`docs/details/security.md`](details/security.md) 詳細本文責務 §27.43 | `api`、`sdk`、`ui`、`statefile` |
| [`docs/details/security.md`](details/security.md) 詳細本文責務 §27.44 | 監査ログ | `security` | [`docs/details/security.md`](details/security.md) 詳細本文責務 §27.44 | `api`、`statefile` |
| [`docs/details/security.md`](details/security.md) 詳細本文責務 §27.45 | セッションタイムアウト変更設定 | `security` | [`docs/details/security.md`](details/security.md) 詳細本文責務 §27.45 | `api`、`sdk`、`ui`、`statefile` |
| [`docs/details/security.md`](details/security.md) 詳細本文責務 §27.46 | TOTP 二要素認証 | `security` | [`docs/details/security.md`](details/security.md) 詳細本文責務 §27.46 | `api`、`sdk`、`ui`、`statefile` |
| [`docs/details/security.md`](details/security.md) 詳細本文責務 §27.47 | API レート制限 | `security` | [`docs/details/security.md`](details/security.md) 詳細本文責務 §27.47 | `api`、`sdk`、`ui`、`statefile` |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.1 | 差分ビルド | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.1 | `runner`、`statefile` |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.2 | 複数出力形式 | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.2 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.3 | Markdown 拡張記法サポート | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.3 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.4 | コードブロック行番号表示 | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.4 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.5 | 見出しの自動採番 | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.5 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.6 | セクション折りたたみ | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.6 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.7 | TOC 深さ制御 | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.7 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.8 | 最終更新日の自動埋め込み | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.8 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.9 | diff ハイライト | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.9 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.10 | 画像の遅延読み込み | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.10 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.11 | カスタムメタタグ注入 | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.11 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.12 | ライトモード固定 | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.12 | [`docs/DESIGN.md`](DESIGN.md) デザイン責務 |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.13 | コードブロックのファイル名表示 | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.13 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.14 | テンプレート変数展開 | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.14 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.15 | HTML ミニファイ | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.15 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.16 | TOC ハイライト追従 | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.16 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.17 | Mermaid ダイアグラム描画 | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.17 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.18 | 脚注サポート | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.18 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.19 | インライン数式レンダリング | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.19 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.20 | ページ内ナビゲーション履歴 | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.20 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.21 | 読み上げ対応（アクセシビリティ） | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.21 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.22 | 画像ライトボックス | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.22 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.23 | 印刷時 QR コード挿入 | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.23 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.24 | 定義リストサポート | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.24 | なし |
| [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.25 | タスクリストサポート | `builder` | [`docs/details/builder.md`](details/builder.md) 詳細本文責務 §28.25 | なし |

補足確認は以下に限定する。[`docs/ROADMAP.md`](ROADMAP.md) 状態・計画責務 §6.3 の補足確認表は実装本文を追加せず、主本文を読む際の境界確認だけを示す。

| 対象 | 補足確認 |
|------|----------|
| [`docs/details/commitstatus.md`](details/commitstatus.md) 詳細本文責務 §27.1 | Commit Status payload と送信順は `commitstatus`、build 実行と最終結果確定は `runner` を参照する。 |
| [`docs/details/api.md`](details/api.md) 詳細本文責務 §27.11 | systemd timer 反映の導入・検証手順は [`docs/details/setup.md`](details/setup.md) 詳細本文責務 §26 を参照する。 |
| [`docs/details/archive.md`](details/archive.md) 詳細本文責務 §27.15 | snapshot 作成トリガーは [`docs/details/runner.md`](details/runner.md) 詳細本文責務 §14b、artifact 操作は `archive` を参照する。 |
...
横断補足契約と owner component 別の [`docs/details/*.md`](details/) 詳細本文責務または [`docs/details/fixture.md`](details/fixture.md) fixture 証跡責務の内容が矛盾する場合は、個別機能の入出力、状態、処理、異常系、endpoint、SDK、UI は owner component 別の [`docs/details/*.md`](details/) 詳細本文責務、fixture、expected、fake、実装検証証跡は [`docs/details/fixture.md`](details/fixture.md) fixture 証跡責務を基準とし、横断処理順、API / SDK / UI / statefile 同期、成功後再取得、失敗時固定だけを横断補足契約で確認する。横断補足契約にだけ存在する endpoint、SDK method、UI 操作、状態ファイル、設定 key、fixture の扱いは、[`docs/SPEC.md`](SPEC.md) 方針責務 §4.2a、該当 owner component 別の [`docs/details/*.md`](details/) 詳細本文責務、[`docs/details/fixture.md`](details/fixture.md) fixture 証跡責務を参照する。
...
| multi-file write | 全入力検証 → 全対象 read → 全 write payload 生成 → [`docs/details/api.md`](details/api.md) 詳細本文責務 §22.0d の Write 順に atomic write → JSON Lines 追記 → response。途中失敗時は未処理ファイルを書かない。 |

[`docs/details/runner.md`](details/runner.md) 詳細本文責務 §27.21〜§27.38 の実装確認では、状態ファイル、endpoint、SDK method、UI 操作、外部公開構成が owner component 別の [`docs/details/*.md`](details/) 詳細本文責務に存在することを確認する。存在しない項目の追加可否と改訂先は、[`docs/SPEC.md`](SPEC.md) 方針責務 §4.2a、[`docs/SPEC.md`](SPEC.md) ポリシー責務 §0、該当 owner / collaborator component 別の [`docs/details/*.md`](details/) 詳細本文責務を参照する。
